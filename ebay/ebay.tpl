...
<table border="0" cellpadding="0" cellspacing="0" class="ProductPrestashop">
    ...
    <tr class="headerProductPrestashop">
        <td class="headerLeftProductPrestashop"><img src="{$shop_logo|escape:'htmlall':'UTF-8'}"
                                                     alt="{$shop_name|escape:'htmlall':'UTF-8'}"/></td>
        <td class="headerCenterProductPrestashop">{literal}{SLOGAN}{/literal}</td>
        <td class="headerRightProductPrestashop">
            <a href="http://feedback.ebay.fr/ws/eBayISAPI.dll?ViewFeedback2&userid={literal}{EBAY_IDENTIFIER}{/literal}&sspagename=VIP:feedback&ftab=FeedbackAsSeller">{l s='See our ratings' mod='ebay'}
                <img src="{$module_url|escape:'htmlall':'UTF-8'}views/img/stats.png"
                     alt="{l s='See our ratings' mod='ebay'}" border="0"/></a><br/>
