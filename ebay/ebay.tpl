...
*}
<link rel="stylesheet" type="text/css" href="{$module_url|escape:'htmlall'}css/ebay.css" />
...
<tbody>
	<tr class="headerProductPrestashop">
		...
		<td class="headerRightProductPrestashop">
			<a href="http://feedback.ebay.fr/ws/eBayISAPI.dll?ViewFeedback2&userid={literal}{EBAY_IDENTIFIER}{/literal}&sspagename=VIP:feedback&ftab=FeedbackAsSeller">{l s='See our ratings' mod='ebay'} <img src="{$module_url|escape:'htmlall'}img/stats.png" alt="{l s='See our ratings' mod='ebay'}" border="0" /></a><br />
			<a href="http://my.ebay.fr/ws/eBayISAPI.dll?AcceptSavedSeller&sellerid={literal}{EBAY_IDENTIFIER}{/literal}&ssPageName=STRK:MEFS:ADDSTR">{l s='Add this shop to my favorites' mod='ebay'} <img src="{$module_url|escape:'htmlall'}img/favorite.png" alt="{l s='Add this shop to my favorites' mod='ebay'}" border="0" /></a><br /><br />
